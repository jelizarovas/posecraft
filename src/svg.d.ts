import {SceneDocument,Camera} from './schema.js';
import {Frame} from './scene.js';
export interface SVGOptions {camera?:Camera;label?:string;colliders?:boolean;selectedProp?:string;bones?:boolean;physicsDebug?:boolean;limits?:boolean;selectedActor?:string;selectedJoint?:string}
