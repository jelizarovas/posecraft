...
export interface PosecraftHandle {play():void;pause():void;reset():void;seek(time:number):void;refreshScroll():void;interact(actor:string,type:Interaction,strength?:number):void;readonly controller:SceneController|WorkerSceneController|undefined}
