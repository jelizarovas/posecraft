...
export class SceneController {
 ...
 objectCommandAck(command:ObjectCommand):boolean|void;
 snapshot():GameSceneSnapshot;restore(snapshot:unknown):Frame;
 setActorSleeping(actor:string,sleeping:boolean):boolean;
