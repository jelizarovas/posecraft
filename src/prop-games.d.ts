...
export interface PropGame {id:string;type:'catch';object:string;participants:CatchParticipant[];seed:number;variation:number;flightTime:number;pause:number;enabled?:boolean}
