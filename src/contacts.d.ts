...
export interface ContactDiagnostic {id:string;actor:string;active:boolean;reason:string|null;target:{x:number;y:number};actual:{x:number;y:number};error:number;limited:boolean}
