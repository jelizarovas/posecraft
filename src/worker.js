...
export class WorkerSceneController {
 ...
 triggerEnsemble(type){if(!this.document.ensemble||!['conversation','doze','meteor','share'].includes(type))throw new Error('Unknown ensemble event.');this.command('triggerEnsemble',[type]);}
