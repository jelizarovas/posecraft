...
export interface ShotActor {clip:string;offset:number;speed:number;emotion?:string;expressions?:[number,string][];placement?:Partial<Record<'x'|'y'|'scale'|'rotation',Keyframe[]>>;pose?:Record<string,Keyframe[]>;motion?:ProceduralMotion}
