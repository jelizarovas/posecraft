...
export function renderCanvas(context:CanvasRenderingContext2D,drawing:EvaluatedDrawing,options?:{clear?:boolean;background?:string;viewport?:Matrix}):{drawn:number;pathCacheSize:number};
