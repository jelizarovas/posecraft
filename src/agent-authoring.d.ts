...
export function inspectScene(document:SceneDocument):{id:string;name:string;revision:number;bounds:SceneDocument['bounds'];requiredFeatures:string[];actors:SceneDocument['actors'];objects:NonNullable<SceneDocument['objects']>;props:NonNullable<SceneDocument['props']>;packs:Record<string,unknown>;contacts:SceneContact[];interactions:PointerBinding[];diagnostics:SceneDiagnostics};
