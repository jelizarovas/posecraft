...
function drawLighting(){
 ...
 const surface=select('shading','Character shading',[['gradient','Soft gradient'],['cel','Sharp / cel']])+`<div class="two-col">${field('Key color','lighting-color',l.color,'type="color"')}${field('Shadow color','lighting-shadowColor',l.shadowColor,'type="color"')}</div>`+sliders([['celThickness','Cel thickness',0,1,.05],['celIntensity','Cel intensity',0,1,.05],['intensity','Light strength',0,2,.05],['ambient','Ambient',0,1,.05],['gloss','Highlights',0,1,.05]]);
