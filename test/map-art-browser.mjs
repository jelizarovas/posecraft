...
try{
 ...
 await page.waitForFunction(()=>a.stats().art.loaded===3&&b.stats().art.loaded===3);assert.deepEqual(requests.sort(),['grass','sprite'],'Images shared between aliases and mounts; unreferenced image must not load');
