...
try{
 const page=await browser.newPage({viewport:{width:1440,height:950},reducedMotion:'reduce'}),errors=[],panels=[];page.setDefaultTimeout(30000);page.on('pageerror',e=>errors.push(e.message));await page.routeWebSocket('**',socket=>socket.close());await page.goto(base+'/demos.html?legacy=1#gym-routine');
