...
| Characters | Ona with 13 actions and six hair options; portable wwwzard with 10 actions; seated Rusty with eight actions; eight emotions each; original wwwzard demo preserved | Ona elbow/palm separation, quadruped locomotion, procedural cloth in portable packs, scene fallbacks |
