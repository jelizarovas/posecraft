...
export async function compileScene(document,outDir){
  ...
  for(const [feature,name,symbol,key] of [['actor-behaviors','actor-behaviors.js','ActorBehaviorRuntime','actorBehaviorFactory'],['motion-layers','motion-layers.js','applyMotionLayers','motionLayerSolver'],['scene-objects','scene-objects.js','SceneObjects','objectFactory'],['prop-games','prop-games.js','PropGameRuntime','gameFactory'],['bottle-fluid','bottle-fluid.js','BottleFluid','fluidFactory'],['bottle-fluid','bottle-browser.js','mountBottleControls','mountBottleControls'],['ensemble','ensemble.js','CampfireEnsemble','ensembleFactory'],['contacts','contacts.js','applyContacts','contactSolver'],['behaviors','behaviors.js','BehaviorRuntime','behaviorFactory'],['pointer-interactions','pointer-interactions.js','ScenePointerInteraction','pointerFactory'],['pointer-interactions','pointer-browser.js','mountScenePointers','mountPointers']])if(inspection.features.includes(feature)){imports.push(`import {${symbol}} from ${moduleURL(name)};`);providers.push(`${key}:${symbol}`);}
