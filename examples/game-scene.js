...
export function createGameExample(){
 const scene=structuredClone(ona);scene.id='corner-shop';scene.name='The corner shop';scene.bounds={width:900,height:500};scene.presentation='live';
 ...
 scene.game={anchors:{'shop.front':{type:'prop',prop:'shop',offsetX:-185,offsetY:160},'shop.sign':{type:'prop',prop:'shop',offsetY:-118},'home':{type:'point',x:175,y:440},'friend':{type:'joint',actor:'friend',joint:'root'}},actors:{shopkeeper:{actions:{inspect:'think',notice:'nod'},reactions:{success:{action:'celebrate',emotion:'happy'},encourage:{action:'wave',emotion:'happy'},surprise:{action:'notice',emotion:'surprised'}},gaze:{joint:'head',maxAngle:20},speech:true},friend:{reactions:{success:{action:'wag',emotion:'happy'},encourage:{action:'tilt',emotion:'curious'},surprise:{action:'bark',emotion:'surprised'}}}}};
 return scene;
}
