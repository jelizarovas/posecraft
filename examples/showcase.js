...
export const demoCatalog=[
 {id:'campfire-night',title:'Campfire night',category:'Four friends after dark',description:'Four Onas roast marshmallows under drifting clouds. Stay a while: snacks burn, get eaten and are replaced, and meteors cross the night sky.',features:['4 distinct Onas','Flickering point light','Roast, eat & replace'],instruction:'Watch the staggered cooking loop, or jump to a moment. The fire lights each camper from its position; the night has no wall shadows.',color:'#172b3a',kind:'scene'},
