...
export const demoCatalog=[
 {id:'campfire-night',title:'Campfire night',category:'Four friends after dark',description:'Four friends gather around the fire, chat, drift off and notice shooting stars. Distractions can burn dinner; sometimes a friend shares a treat.',features:['Around the fire','Shared reactions','Seeded live events'],instruction:'Let the evening unfold, or start a conversation, meteor or handoff. New evening changes the events; the slider replays the first minute.',color:'#172b3a',kind:'scene'},
